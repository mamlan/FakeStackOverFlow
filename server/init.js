...
function createUser(username, pass, email, admin, reputation){
...
let admin_username = userArgs[0];
let admin_password = userArgs[1];
const saltRounds = 10;
const hashedPass = bcrpyt.hashSync(admin_password, saltRounds);

const populate = async () => {
  let u1 = await createUser(admin_username, hashedPass, 'admin@gmail.com', true, 50);
